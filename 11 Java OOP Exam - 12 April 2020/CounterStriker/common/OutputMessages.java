...
public class OutputMessages {
    ...
    public static final String PLAYER_INFO = "%s: %s";

    public static final String PLAYER_HEALTH = "--Health: %d";

    public static final String PLAYER_ARMOR = "--Armor: %d";

    public static final String PLAYER_GUN = "--Gun: %s";
}